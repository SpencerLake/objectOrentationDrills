...
let tabby = new Cat('Tabby', 10, 'Calicou')
...
let vodar = new Wizard('Vodar', 67, 'Frost Rune')
...
let nokia = new Phone('Nokia', 'brick', 1, 'grey', 50)

nokia.changePrice(10)
//console.log(nokia)
/*
...
let galaxy8 = new Phone('Samsung', 'Galaxy8', 32, 'black', 600)
let iPhone = new Phone('iPhone', 'XR', 64, 'white', 700)
let pixel = new Phone('Google', 'PXL', 64, 'white', 800)
//console.log(galaxy8, iPhone, Pixel)
